...
<section className="h-full px-4 bg-gray-100">
  <div className="max-w-5xl mx-auto py-8">
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div className="flex flex-col justify-center">
        <div>
          ...
          <p className="text-gray-600 mb-4">Brand: <span className="font-semibold">XYZ</span></p>
          <p className="text-gray-600 mb-4">Rating: <span className="font-semibold">4.5/5</span></p>
          <p className="text-gray-600 mb-4">Availability: <span className="font-semibold">In Stock</span></p>
        </div>
    ...
    {/* Description */}
    <div className="my-12">
      <a href="#description" className="px-6 mr-2 py-3 shadow-md rounded-md">
        Description
      </a>
