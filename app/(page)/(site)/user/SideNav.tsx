...
export default function SideNav({
  ...
  const items = [
    { title: "Your Orders", link: "/user/orders" },
  ...
  return (
    <nav
      className={`fixed md:static flex flex-col right-0 w-64 md:w-full bg-white  text-black p-4 inset-y-0 ${
    ...
    >
      ...
      <button
        type="button"
        onClick={onClick}
        className="absolute top-2 left-2 bg-blue-500 h-8 w-8 rounded-full md:hidden text-white"
      >
        X
      </button>
      <hr />
