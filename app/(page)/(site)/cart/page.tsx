        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                >
                  ...
                  <div className="flex flex-col justify-between p-4 w-full">
                    ...
                    <div className="flex mt-2 items-center">
                      ...
                      <span className="block text-center mx-3">
                        {item.quantity}
                      </span>
                      <button
                        type="button"
          ...
          <div className="lg:col-span-4">
            <div className="shadow-md bg-white rounded-md p-6">
              ...
              <Link
                href="/checkout"
                className="px-4 block text-center py-2 w-full bg-blue-500 hover:bg-blue-600 rounded-md text-white"
              >
                Proceed to Checkout
              </Link>
              <Link
                href="/"
                className="block my-3 text-blue-500 hover:underline text-center"
              >
                Continue Shopping
              </Link>
            </div>
