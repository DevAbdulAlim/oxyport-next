          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="flex items-center">
              <div>
                ...
                <button className="px-4 py-2 block bg-blue-900 hover:bg-blue-950 text-white rounded-md">
                  Add To Cart
                </button>
              </div>
            </div>
          ...
          <div className="my-12">
            ...
            <div className="shadow-md p-6">
              ...
              <p>
                ...
                Deleniti, quaerat. Lorem ipsum dolor sit amet consectetur
                adipisicing elit. Voluptatibus temporibus necessitatibus nihil
                deserunt expedita asperiores beatae perspiciatis. Ipsum,
                assumenda! Blanditiis quaerat tenetur deserunt accusamus modi
                aliquid, perspiciatis quasi iure officiis.
              </p>
            </div>
          </div>
        </div>
